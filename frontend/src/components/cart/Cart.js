                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div className="stockCounter d-inline">
                                                    <button className="btn btn-danger minus" onClick={() => decreaseQty(item)}>-</button>
                                                    <input type="number" className="form-control count d-inline" value={item.quantity} readOnly />
                                                    <button className="btn btn-primary plus" onClick={() => increaseQty(item)}>+</button>
                                                </div>
                                            </div>
                                            <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                                <button id="delete_cart_item" onClick={() => dispatch(removeItemFromCart(item.product))} className="fa fa-trash btn btn-danger"></button>
                                            </div>
                                        </div>
                                    </div>
                                </Fragment>
