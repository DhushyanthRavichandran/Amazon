...
export const ProductDetail = () => {
    const { product = {}, isReviewSubmitted, loading, error } = useSelector((state) => state.productState);
    ...
    }, [id, dispatch, error, isReviewSubmitted]);
                    ...
                    <MetaData title={product.name} />
                     <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <span id="no_of_reviews">({product.reviews ? product.reviews.length : 0} Reviews)</span>
                            <hr />
                            <p id="product_price">${product.price}</p>
                            <div className="stockCounter d-inline">
                                <span onClick={decrementQuantity} className="btn btn-danger minus">-</span>
                                <input
                                    type="number"
                                    ...
                                    readOnly
                                />
                                <span onClick={incrementQuantity} className="btn btn-primary plus">+</span>
                            </div>
                            <button
                                type="button"
                                id="cart_btn"
